...
import 'package:dating/Screens/Chat/Matches.dart';
import 'package:dating/Screens/Profile/EditProfile.dart';
import 'package:dating/Screens/reportUser.dart';
                        ...
                        itemBuilder: (BuildContext context, int index2) {
                          return user.imageUrl.length != null
                              ? Hero(
                                  tag: "abc",
                                  child: FadeInImage(
                                    image: NetworkImage(user.imageUrl[index2] ?? ''),
                                    fit: BoxFit.cover,
