...
class LivingCity extends StatefulWidget {
  @override
  _LivingCityState createState() => _LivingCityState();
}


class _LivingCityState extends State<LivingCity> {
                  ...
                  ? Padding(
                      ...
                      child: Align(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            userData.addAll({'living_in': livingCity});
                            print(userData);
                            Navigator.push(
                                context,
                                CupertinoPageRoute(
